# 1 "src/interrupt_control_module/interrupt_control.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/interrupt_control_module/interrupt_control.c" 2
...
# 2 "src/interrupt_control_module/interrupt_control.c" 2
...
# 5 "src/interrupt_control_module/interrupt_setup.h" 2
...
# 3 "src/interrupt_control_module/interrupt_control.c" 2
# 1 "src/interrupt_control_module/../uart_control_module/UART_setup.h" 1
...
# 4 "src/interrupt_control_module/interrupt_control.c" 2
# 1 "src/interrupt_control_module/../timer_control_module/timer_module.h" 1
...
# 5 "src/interrupt_control_module/interrupt_control.c" 2
...
void __attribute__((picinterrupt(("")))) ISR (void)
{
    ...
    if ((PIR0 & 0b00100000) == 0b00100000)
    {
        PIR0 = PIR0 & ~0b00100000;
        timer_0_stop();
        copy_rx_1_buffer();
