# 1 "src/interrupt_control_module/interrupt_setup.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/interrupt_control_module/interrupt_setup.c" 2
...
# 2 "src/interrupt_control_module/interrupt_setup.c" 2
