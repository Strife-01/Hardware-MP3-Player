...
# 3 "src/MP3_project.c" 2

# 1 "src/config_bits.h" 1
# 10 "src/config_bits.h"
...
# 79 "src/config_bits.h" 2
# 5 "src/MP3_project.c" 2
...
# 6 "src/MP3_project.c" 2
# 1 "src/interrupt_control_module/interrupt_setup.h" 1
...
# 7 "src/MP3_project.c" 2
# 1 "src/interrupt_control_module/interrupt_control.h" 1
# 10 "src/interrupt_control_module/interrupt_control.h"
void clear_command_copy_buffer (void);


unsigned char rx_1_buffer_receive[100];
unsigned char rx_copy_buffer[100];
...
# 8 "src/MP3_project.c" 2
# 1 "src/uart_control_module/UART_setup.h" 1
...
# 9 "src/MP3_project.c" 2
# 1 "src/kt403_control_module/KT403A.h" 1
# 68 "src/kt403_control_module/KT403A.h"
...
# 10 "src/MP3_project.c" 2
# 1 "src/curiosity_leds_module/curiosity_leds_module.h" 1
# 12 "src/curiosity_leds_module/curiosity_leds_module.h"
...
# 11 "src/MP3_project.c" 2
# 1 "src/utils.h" 1



void busy_wait (unsigned long iterations);
# 12 "src/MP3_project.c" 2
