# 1 "src/kt403_control_module/KT403A.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/kt403_control_module/KT403A.c" 2
...
# 5 "src/kt403_control_module/KT403A.h" 2
...
# 2 "src/kt403_control_module/KT403A.c" 2
# 1 "src/kt403_control_module/../uart_control_module/UART_setup.h" 1
...
# 3 "src/kt403_control_module/KT403A.c" 2

void setup_reset_kt403a (void)
{
    TRISD = TRISD & 0b11111110;
    ANSELD = ANSELD & 0b11111110;
}

void reset_chip (void)
{
    PORTD = PORTD | (unsigned char) ~0b11111110;
}
...
# 110 "src/kt403_control_module/KT403A.c"
void standby (void)
{
    reset_buffer_small();
