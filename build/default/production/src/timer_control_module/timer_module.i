# 1 "src/timer_control_module/timer_module.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/timer_control_module/timer_module.c" 2
# 1 "src/timer_control_module/timer_module.h" 1
...
# 5 "src/timer_control_module/timer_module.h" 2

void timer_0_reset (void);
void timer_0_stop (void);
# 2 "src/timer_control_module/timer_module.c" 2
# 12 "src/timer_control_module/timer_module.c"
...
void timer_0_reset (void)
{
    ...
    timer_0_offset = (unsigned int) (300);
    timer_0_low = (unsigned char) timer_0_offset;
    timer_0_high = (unsigned char) (timer_0_offset >> 8);


    T0CON0 = T0CON0 & 0b01111111;


    T0CON1 = T0CON1 & 0b11101111;


    T0CON1 = T0CON1 | 0b01000000;
    T0CON1 = T0CON1 & 0b01001111;


    T0CON0 = T0CON0 | 0b10010000;
    T0CON0 = T0CON0 & 0b10011111;
    ...
    T0CON0 = T0CON0 | (unsigned char) ~0b01111111;


    PIE0 = PIE0 | 0b00100000;
}
