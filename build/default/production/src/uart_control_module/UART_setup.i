# 1 "src/uart_control_module/UART_setup.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "src/uart_control_module/UART_setup.c" 2
...
# 5 "src/uart_control_module/UART_setup.h" 2
...
# 2 "src/uart_control_module/UART_setup.c" 2
# 1 "src/uart_control_module/../interrupt_control_module/interrupt_setup.h" 1
...
# 3 "src/uart_control_module/UART_setup.c" 2
# 23 "src/uart_control_module/UART_setup.c"
void RX_setup (void)
{
    ...
    ANSELC = ANSELC & 0b01111111;


    RC1STA = RC1STA | 0b10000000;


    RC1STA = RC1STA & 0b10111111;
...
void TX_setup (void)
{
    ...
    ANSELC = ANSELC & 0b10111111;


    TRISC = TRISC & 0b10111111;


    TX1STA = TX1STA & 0b11101111;


    TX1STA = TX1STA & 0b10111111;


    TX1STA = TX1STA | 0b00000100;
